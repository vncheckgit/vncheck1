...
function addGoogleAdSense(){bookConfig.haveAdSense&&bookConfig.adSenseClientId&&loadJavascript("/patch/js/null.js?pagead2.googlesyndication.com/pagead/js/adsbygoogle.js",function(){var b=document.createElement("ins");b=$(b);b.addClass("adsbygoogle");b.css({display:"inline-block",width:"100%",height:"100%"});b.attr("data-ad-client",bookConfig.adSenseClientId);b.attr("data-ad-slot",bookConfig.adSenseSlotId);var c=$("<div/>");c.css({position:"absolute","z-index":100,left:bookConfig.adSenseLeft+"px",top:bookConfig.adSenseTop+
...
var isBool=function(b){
  if(!0===b||!1===b)return!0;if(void 0==b)return!1;var c=["false","no","hide","disable"];b=b.toLowerCase();return 0>["true","yes","show","enable"].indexOf(b)&&0>c.indexOf(b)?!1:!0},getValueFromConfig=function(b,c){
  // console.log("--fx--getValueFromConfig--", b,c);
  if (b=="UIBaseURL") {
    console.log("--UIBaseURL--", b, c);
    return "./static-fliphtml5-com/resourceFiles/html5_templates/template/Popular/";
  }
  if (b== "appLogoIcon") {
    console.log("--appLogoIcon--", b, c);
    return "patch/fliphtml5/booklogo.png";
  }
  if (b== "bookBaseURL") {
    console.log("--bookBaseURL--", b, c);
    return "patch/fliphtml5/";
  }
  if (b=="HomeURL") {
    return "https://vncheck.com/";
  }
  if (b=="homePage") {
    return "https://vncheck.com/";
  }
  ...
  console.log("b", b);
  b=function(d,e){DeConfig_Parse(d);getEditConfig(d);void 0!=e&&"string"==typeof e&&""!=e.trim()&&isBool(e)&&(e=parseBool(e));d=void 0!=tmpBookConfig[d]?tmpBookConfig[d]:getValueFromAliasConfig(d);return void 0==d?e:void 0==e?d:"number"==typeof e?Number(d):"boolean"==typeof e?
parseBool(d):"string"==typeof e&&"#"==e[0]?Color(d).toString():d}(b,c);"string"==typeof b&&(b=b.replaceAll("\\/","/",!0),b=b.replaceAll('\\"','"'),b.startsWith("[")&&b.endsWith("]")&&(b=eval(b)));
  console.log("b", b);
return b

},getConfigValue=function(b,c){b=getValueFromConfig(b,c);"string"==typeof b&&0<=b.indexOf("files")&&(b=fixURLValue(b));return b};
